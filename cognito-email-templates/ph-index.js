...
exports.handler = async (event, context, callback) => {
            ...
            <tr>
                <td align="center">
                    <div style="border:1px solid black; width: 600px; text-align: left; padding: 5px; font-family: Tahoma; font-size: 12pt; font-color: #424242;">
                        ...
                        <footer>
                            <div align="center">
                                <a href="https://www.${domain}.com"><img src="https://sabre-images.s3.amazonaws.com/FindingCRELogo.png" alt="${domain} - Commercial Real Estate for Sale or Lease" title="Phoma - Commercial Real Estate for Sale or Lease"></a>
                            </div>
                        </footer>
                    </div>
                </td>
  ...
  if (event.triggerSource === "CustomMessage_SignUp" || event.triggerSource === "CustomMessage_ResendCode" ) {
    ...
    event.response = {
        emailSubject: "Verify your Phowma account",
  ...
  if (event.triggerSource === "CustomMessage_ForgotPassword") {
    ...
    event.response = {
        emailSubject: "Change your Phowma password",
